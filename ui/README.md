...
A modern, production-ready web interface for the [Bifrost AI Gateway](https://github.com/grevinden/bifrost) - providing real-time monitoring, configuration management, and comprehensive observability for your AI infrastructure.
...
- **Main Repository**: [github.com/grevinden/bifrost](https://github.com/grevinden/bifrost)
