...
const docSections = [
	{
		...
		icon: Play,
		url: "https://github.com/grevinden/bifrost/tree/main/docs/quickstart",
		badge: "Popular",
	...
	},
	{
		...
		icon: GitBranch,
		url: "https://github.com/grevinden/bifrost/tree/main/docs/architecture",
	...
	},
	{
		...
		icon: BookOpen,
		url: "https://github.com/grevinden/bifrost/tree/main/docs/usage",
		badge: "Comprehensive",
	...
	},
	{
		...
		icon: Users,
		url: "https://github.com/grevinden/bifrost/tree/main/docs/contributing",
	...
	},
	{
		...
		icon: Code,
		url: "https://github.com/grevinden/bifrost/tree/main/docs/usage/http-transport/integrations",
	...
	},
	{
		...
		icon: Zap,
		url: "https://github.com/grevinden/bifrost/blob/main/docs/benchmarks.md",
...
const featuredDocs = [
	{
		...
		href: "https://github.com/grevinden/bifrost/blob/main/docs/mcp.md",
		icon: FileText,
	...
	},
	{
		...
		href: "https://github.com/grevinden/bifrost/blob/main/docs/governance.md",
		icon: Shield,
				...
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<div className="flex justify-center gap-4">
							<Button asChild>
								<a
									href="https://github.com/grevinden/bifrost/tree/main/docs"
									target="_blank"
							...
							<Button variant="outline" asChild>
								<a
									href="https://github.com/grevinden/bifrost/tree/main/docs/quickstart"
									target="_blank"
									rel="noopener noreferrer"
