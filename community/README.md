...
If you'd like to propose a new community-maintained catalog, open a [feature request](https://github.com/grevinden/bifrost/issues/new?template=feature_request.yml) describing:
