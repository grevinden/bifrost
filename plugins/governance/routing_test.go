...
func TestEvaluateRoutingRules_GlobalRuleMatches(t *testing.T) {
	...
	rule := &configstoreTables.TableRoutingRule{
		...
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: new("azure"), Model: new("gpt-4-turbo"), Weight: 1.0},
		},
		Enabled:  new(true),
		Scope:    "global",
		Priority: 0,
...
func TestEvaluateRoutingRules_ScopePrecedence(t *testing.T) {
	...
	globalRule := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: new("openai"), Model: new("gpt-4o"), Weight: 1.0},
		},
		Enabled:  new(true),
		Scope:    "global",
		Priority: 0,
...
func TestEvaluateRoutingRules_ChainRuleReEvaluation(t *testing.T) {
	...
	ruleA := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: new("openai"), Model: new("gpt-4-turbo"), Weight: 1.0},
		},
		Enabled:   new(true),
		Scope:     "global",
		Priority:  0,
	...
	ruleB := &configstoreTables.TableRoutingRule{
		...
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: new("azure"), Model: new("gpt-4"), Weight: 1.0},
		},
		Enabled:   new(true),
		Scope:     "global",
		Priority:  1,
...
func TestEvaluateRoutingRules_SelfLoopContinuesToNextRule(t *testing.T) {
	...
	ruleB := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: new("anthropic"), Model: new("claude-3"), Weight: 1.0},
		},
		Enabled:   new(true),
		Scope:     "global",
		Priority:  1,
...
func TestEvaluateRoutingRules_MaxDepthCutoff(t *testing.T) {
	...
	engine, err := NewRoutingEngine(store, NewMockLogger(), new(2))
	require.NoError(t, err)
...
func TestCompileAndCacheProgram_ValidExpression_Routing(t *testing.T) {
	...
	rule := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: new("openai"), Weight: 1.0},
		},
		Enabled: new(true),
	}
...
func TestEvaluateCELExpression_NilProgram(t *testing.T) {
	_, err := evaluateCELExpression(nil, map[string]any{})
	assert.Error(t, err)
