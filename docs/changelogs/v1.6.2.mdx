...
<Warning>
v1.6.2 has a [known CPU spike issue](https://github.com/grevinden/bifrost/issues/4851) for large number of budgets/teams/customers. The fix is part of v1.6.3
</Warning>
...
- [#4797](https://github.com/grevinden/bifrost/issues/4797) — [Bug]: configstore migration order — refresh_config_hash_after_mcp_external_server_url_removal (#139) selects dump_errors_in_console_logs before add_dump_errors_in_console_logs_column (#160) adds it
