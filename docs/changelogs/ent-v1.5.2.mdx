...
<Warning>
v1.5.2 has a [known CPU spike issue](https://github.com/grevinden/bifrost/issues/4851) for large number of budgets/teams/customers. The fix is part of v1.5.3
</Warning>
...
- [#4797](https://github.com/grevinden/bifrost/issues/4797) - Configstore migration order: `refresh_config_hash_after_mcp_external_server_url_removal` (#139) selected `dump_errors_in_console_logs` before `add_dump_errors_in_console_logs_column` (#160) added it
...
require (
	...
	github.com/grevinden/bifrost/core v1.6.2
	github.com/grevinden/bifrost/framework v1.4.2
	github.com/grevinden/bifrost/plugins/governance v1.6.2
	github.com/grevinden/bifrost/plugins/logging v1.5.25
	github.com/grevinden/bifrost/plugins/prompts v1.0.25
	github.com/grevinden/bifrost/plugins/semanticcache v1.5.25
	github.com/grevinden/bifrost/transports v1.6.2
...
require (
	...
	github.com/grevinden/bifrost/plugins/compat v0.1.24 // indirect
	github.com/grevinden/bifrost/plugins/maxim v1.6.25 // indirect
	github.com/grevinden/bifrost/plugins/mocker v1.5.25 // indirect
	github.com/grevinden/bifrost/plugins/modelcatalogresolver v1.0.6 // indirect
	github.com/grevinden/bifrost/plugins/otel v1.3.2 // indirect
	github.com/grevinden/bifrost/plugins/telemetry v1.5.25 // indirect
