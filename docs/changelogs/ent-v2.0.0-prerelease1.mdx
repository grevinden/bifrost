...
`github.com/grevinden/bifrost/transports v1.6.4-0.20260707051148-814c55d5f8a0`

## 🔌 If you are compiling plugin against this release - use following deps

The enterprise repo is now a multi-module workspace; the `github.com/grevinden/bifrost-enterprise/*` modules at `v0.0.0` resolve via the `replace` directives to the release source checkout.

```go
module github.com/grevinden/bifrost-enterprise/transports
...
require (
	...
	github.com/grevinden/bifrost-enterprise/core v0.0.0
	github.com/grevinden/bifrost-enterprise/framework v0.0.0
	github.com/grevinden/bifrost-enterprise/plugins v0.0.0
	github.com/grevinden/bifrost/core v1.7.0
	github.com/grevinden/bifrost/framework v1.5.0
	github.com/grevinden/bifrost/plugins/governance v1.6.4
	github.com/grevinden/bifrost/plugins/logging v1.6.0
	github.com/grevinden/bifrost/plugins/semanticcache v1.5.27
	github.com/grevinden/bifrost/transports v1.6.4-0.20260707051148-814c55d5f8a0
...
require (
	...
	github.com/grevinden/bifrost/plugins/compat v0.1.26 // indirect
	github.com/grevinden/bifrost/plugins/maxim v1.6.27 // indirect
	github.com/grevinden/bifrost/plugins/mocker v1.5.27 // indirect
	github.com/grevinden/bifrost/plugins/modelcatalogresolver v1.0.8 // indirect
	github.com/grevinden/bifrost/plugins/otel v1.3.4 // indirect
	github.com/grevinden/bifrost/plugins/prompts v1.0.27 // indirect
	github.com/grevinden/bifrost/plugins/telemetry v1.5.27 // indirect
...
replace github.com/grevinden/bifrost-enterprise/core => ../core

replace github.com/grevinden/bifrost-enterprise/framework => ../framework

replace github.com/grevinden/bifrost-enterprise/plugins => ../plugins
```
