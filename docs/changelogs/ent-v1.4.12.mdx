---
title: "v1.4.12"
description: "Enterprise v1.4.12 changelog - 2026-06-17"
---

<Update label="Bifrost Enterprise" description="v1.4.12">
...
- **Okta SCIM Pagination (enterprise)** - The Okta provisioning client now uses `Header.PeekAll("Link")` instead of `Peek`, so it sees every `Link` header Okta returns. Okta sends one header per `rel`, and fasthttp's `Peek` only exposed the first, so pagination stopped after the first page. The `rel="next"` match also no longer assumes a fixed attribute position, so paginated user syncs follow the `next` link across all pages.
...
require (
	...
	github.com/grevinden/bifrost/core v1.5.21
	github.com/grevinden/bifrost/framework v1.3.21
	github.com/grevinden/bifrost/plugins/governance v1.5.21
	github.com/grevinden/bifrost/plugins/logging v1.5.21
	github.com/grevinden/bifrost/plugins/prompts v1.0.21
	github.com/grevinden/bifrost/plugins/semanticcache v1.5.21
	github.com/grevinden/bifrost/transports v1.5.15
...
require (
	...
	github.com/grevinden/bifrost/plugins/compat v0.1.20 // indirect
	github.com/grevinden/bifrost/plugins/maxim v1.6.21 // indirect
	github.com/grevinden/bifrost/plugins/mocker v1.5.21 // indirect
	github.com/grevinden/bifrost/plugins/modelcatalogresolver v1.0.2 // indirect
	github.com/grevinden/bifrost/plugins/otel v1.2.22 // indirect
	github.com/grevinden/bifrost/plugins/telemetry v1.5.21 // indirect
