...
Want to see Bifrost's performance in your specific environment? The [**Bifrost Benchmarking Repository**](https://github.com/grevinden/bifrost-benchmarking) provides everything you need to conduct comprehensive performance tests tailored to your infrastructure and workload requirements.
...
- **[mocker](https://github.com/grevinden/bifrost-benchmarking/tree/main/mocker)** — a mock LLM provider server with configurable latency, failures, and rate limits. Point your gateways at it to measure pure gateway overhead with zero API costs.
- **[hitter](https://github.com/grevinden/bifrost-benchmarking/tree/main/hitter)** — a load generator for stress-testing a single Bifrost deployment with realistic multi-model/streaming traffic.
...
- **Target providers** configured in Bifrost (real providers, or the [mocker](https://github.com/grevinden/bifrost-benchmarking/tree/main/mocker) for cost-free runs)
...
```bash
git clone https://github.com/grevinden/bifrost-benchmarking.git
...
To compare against other gateways, add their port variables too — the [repo README](https://github.com/grevinden/bifrost-benchmarking#readme) lists every supported gateway and its `.env` variable.
...
| `-provider <name>` | ❌ | Gateway to benchmark: `bifrost`, `openai`, or another supported gateway (full list in the [repo README](https://github.com/grevinden/bifrost-benchmarking#readme)); empty runs all | None (all) |
...
- Point the gateway at the repo's [mock provider](https://github.com/grevinden/bifrost-benchmarking/tree/main/mocker) to eliminate upstream variability
...
**Ready to benchmark? Clone the [repository](https://github.com/grevinden/bifrost-benchmarking) and start testing!**
