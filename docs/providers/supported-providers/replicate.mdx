...
**Response**: [`BifrostVideoGenerationResponse`](https://github.com/grevinden/bifrost/blob/main/core/schemas/videos.go) - `id`, `status`, `model`, `videos[]`
...
- [Bifrost Replicate Provider Source](https://github.com/grevinden/bifrost/tree/main/core/providers/replicate)
