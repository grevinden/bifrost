...
**Response**: [`BifrostImageGenerationResponse`](https://github.com/grevinden/bifrost/blob/main/core/schemas/images.go) with `data[].url` or `data[].b64_json`.
...
**Response**: [`BifrostVideoGenerationResponse`](https://github.com/grevinden/bifrost/blob/main/core/schemas/videos.go) with `id`, `status`, `videos[]`.
...
- [Bifrost Runware Provider Source](https://github.com/grevinden/bifrost/tree/main/core/providers/runware)
