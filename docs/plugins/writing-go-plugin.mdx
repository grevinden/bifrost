...
```bash
go get github.com/grevinden/bifrost/core@latest
```
...
require github.com/grevinden/bifrost/core v1.2.38
```
...
<Tip>
The full working example covering all four MCP hooks (envelope + Connect) lives at [`examples/plugins/mcp-only`](https://github.com/grevinden/bifrost/tree/main/examples/plugins/mcp-only). Use it as a starting point rather than retyping the boilerplate.
</Tip>
...
- **All shared packages** (especially `github.com/grevinden/bifrost/core`)
...
my-plugin.so: go1.26.1
  dep  github.com/grevinden/bifrost/core  v1.3.50
...
bifrost-http: go1.26.1
  dep  github.com/grevinden/bifrost/core  v1.3.54   # <-- MISMATCH!
...
go get github.com/grevinden/bifrost/core@v1.3.54
go mod tidy
...
$ go version -m my-plugin.so | grep bifrost
  dep  github.com/grevinden/bifrost/core  v1.3.54  # Now matches!
```
...
- **Full Example**: [examples/plugins/hello-world](https://github.com/grevinden/bifrost/tree/main/examples/plugins/hello-world)
- **main.go**: [Plugin implementation](https://github.com/grevinden/bifrost/blob/main/examples/plugins/hello-world/main.go)
- **Makefile**: [Build configuration](https://github.com/grevinden/bifrost/blob/main/examples/plugins/hello-world/Makefile)
- **go.mod**: [Dependencies](https://github.com/grevinden/bifrost/blob/main/examples/plugins/hello-world/go.mod)

## Real-World Plugin Examples

Explore production-ready plugins in the Bifrost repository:

- **[Mocker Plugin](https://github.com/grevinden/bifrost/tree/main/plugins/mocker)** - Mock responses for testing
- **[Logging Plugin](https://github.com/grevinden/bifrost/tree/main/plugins/logging)** - Advanced request/response logging
- **[Semantic Cache Plugin](https://github.com/grevinden/bifrost/tree/main/plugins/semanticcache)** - Cache based on semantic similarity
- **[Governance Plugin](https://github.com/grevinden/bifrost/tree/main/plugins/governance)** - Rate limiting and budget controls
- **[JSON Parser Plugin](https://github.com/grevinden/bifrost/tree/main/plugins/jsonparser)** - Parse and validate JSON responses

## Frequently Asked Questions

### Do I need to rebuild my plugin when upgrading Bifrost?

**Yes, absolutely.** Plugins must be compiled against the exact same version of `github.com/grevinden/bifrost/core` that Bifrost is using. This is a fundamental requirement of Go's plugin system.
...
go get github.com/grevinden/bifrost/core@v1.3.0
go mod tidy
    ...
    steps:
      ...
      - name: Build Plugins
        run: |
          ...
          go get github.com/grevinden/bifrost/core@${{ env.BIFROST_VERSION }}
          go mod tidy
          go build -buildmode=plugin -o my-plugin.so main.go
...
plugin was built with a different version of package github.com/grevinden/bifrost/core
```
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/grevinden/bifrost/issues)
