...
See the [hello-world plugin Makefile](https://github.com/grevinden/bifrost/blob/main/examples/plugins/hello-world/Makefile) for a complete example.
...
require (
    github.com/grevinden/bifrost/core v1.2.38
    // Optional: Add framework for advanced features
    // github.com/grevinden/bifrost/framework v1.1.48
...
3. **[Example plugins](https://github.com/grevinden/bifrost/tree/main/examples/plugins)** - Study working examples

<Note>
For questions or issues with dynamic builds and plugins, visit our [GitHub Discussions](https://github.com/grevinden/bifrost/discussions) or [Discord community](https://discord.gg/exN5KAydbU).
</Note>
